  ...
  return (
    <div className="space-y-4">
      ...
      <div className="w-full bg-gray-800 p-6 rounded-lg shadow-lg mx-auto mt-10 max-w-screen-lg">
        <h1 className="text-2xl font-bold mb-4 text-center text-white">Real-time Public Chat Room</h1>
          ...
          {messages.map((message) => (
            ...
            >
              ...
              <div className={`${message.user_id == currentUserId ? 'text-right' : ''}`}>
                ...
                <div className={`p-2 rounded-lg max-w-md ${message.user_id === userID ? 'bg-red-900 text-white' : 'bg-purple-900 text-white'}`}>
